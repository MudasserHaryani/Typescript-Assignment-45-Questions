...
let newGuest: string = "Bilawal Bhutto";

guestArr[guestArr.indexOf(canNotAttend)] = newGuest;
console.log(guestArr);

guestArr.map((items) =>
console.log(`Honorable ${items}, I found a bigger dinner table so I am inviting more people.`)
);

// Add one new guest to the beginning of the array
let guestBeg: string = "Sheikh Rasheed";
guestArr.unshift(guestBeg);

// Add one new guest to the middle of the array
let guestMiddle: string = "Shah Mehmood Qureshi";
...
let guestEnd: string = "Kamran Tessori";
